...
import com.eldhimni.controlemobile.R;
...
import com.eldhimni.controlemobile.adapters.EmployeAdapter;
import com.eldhimni.controlemobile.beans.Employe;
import com.eldhimni.controlemobile.beans.Service;
...
public class AddEmployeActivity extends AppCompatActivity {
    ...
    private void addEmploye() {
        ...
        String insertUrl = "http://172.20.10.2:9092/api/employe";
    ...
    private void fetchSpinnerOptionsFromAPI() {
        String Url = "http://172.20.10.2:9092/api/service";
